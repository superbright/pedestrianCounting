...
while(True):
    ...
    ret,thresh2 = cv2.threshold(blurred,10,255,cv2.THRESH_BINARY)
    ...
    for contour, hier in zip(contours, hierarchy):
        ...
        if w > 150 and h > 150 and w < 300 and h < 500 and y > 400:
            cv2.rectangle(output_img, (x,y), (x+w,y+h), (255, 0, 0), 2)
            #cv2.putText(output_img, "Object #{}".format(i + 1),(int(rect[0][0] - 15), int(rect[0][1] - 15)), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (255, 255, 255), 2)
